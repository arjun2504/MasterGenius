...
<font size='4'>To</font> &nbsp;&nbsp;&nbsp;<input type="text" onkeypress="return isNumberKey(event)" name="to"  style="width:430px; height: 30px; border: none; background-color: #f3f5f8; font-size: 20px" placeholder="Type recipient's ID here..." value="<?php if(isset($_GET[s])) echo $_GET[s];?>" required><input type='button' style='padding:5px' value='Browse...' onclick="return popitup('contacts.php')"><br>
...
<?php
$res = mysql_query("SELECT DISTINCT toid FROM messages WHERE fromid = '$id' ORDER BY t DESC");

...
while($row = mysql_fetch_array($q))
{
	...
	echo $row[t];
	echo "</font><br><br>";
	echo nl2br($row[thread]);
	if($row[file] != NULL)
	{
	echo "<h4>Attachments: ";
	echo "<a href='student/uploads/".$row[file]."' target='_blank' style='color: blue'>";
	echo $row[file];
	echo "</a>";
	echo "</h4>";
	}
...
while($row = mysql_fetch_array($shw))
{
	...
	{
	echo "<h4>Attachments: ";
	echo "<a href='student/file/".$row[file]."' target='_blank' style='color: blue'>";
	echo $row[file];
	echo "</a>";
	echo "</h4>";
	}
